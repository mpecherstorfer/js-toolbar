...
(function(root) {
	...
	Toolbar.prototype.observeMenu = function(menu) {
		...
		this.observeMenuTouchScreenEvents(menu);
	...
	/**
	 * Adds touch screen event observers to the given menu.
	 * @private
	 * @param {Object} menu
	 * @returns {Toolbar} Chainable.
	 */
	Toolbar.prototype.observeMenuTouchScreenEvents = function(menu) {
		menu.$lead.on('click', $.proxy(function(ev) {
			this.menuLeadItemActivated(menu);
	...
	/**
	 * When the lead item of the given menu has been activated.
	 * @private
	 * @event
	 * @param {Object} menu
	 * @returns {Toolbar} Chainable.
	 */
	Toolbar.prototype.menuLeadItemActivated = function(menu) {
		this.toggleMenu(menu, this.opt);
		return this;
	};
